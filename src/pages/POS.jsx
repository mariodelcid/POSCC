...
export default function POS() {
  ...
  function openSquareWebPayment() {
    // Create a Square-style payment interface for desktop
    const paymentModal = document.createElement('div');
    paymentModal.id = 'square-web-payment-modal';
    ...
    paymentContent.innerHTML = `
      <div style="margin-bottom: 30px;">
        ...
        <p style="
          ...
          fontSize: 18px;
          color: #6b7280;
        ">Amount: ${centsToUSD(totalCents)}</p>
      </div>
      ...
      <div style="margin-bottom: 30px;">
        ...
        ">
          ...
          ">
            ...
            <span style="color: #6b7280;">Credit/Debit Card</span>
          </div>
          ...
          ">
            ...
            <span style="fontSize: 20px; fontWeight: 700; color: #059669;">${centsToUSD(totalCents)}</span>
          </div>
        </div>
      </div>
      ...
      <div style="margin-bottom: 30px;">
        ...
        ">
          ...
          ">
            ...
            <span style="fontWeight: 600; color: #059669;">Secure Payment</span>
          </div>
          <p style="
            margin: 0;
            fontSize: 14px;
      ...
      <div style="display: flex; gap: 16px;">
        <button id="process-payment-btn" style="
          flex: 1;
          padding: 18px;
          background: #00d4aa;
          color: white;
        ...
        " onmouseover="this.style.background='#00b894'" onmouseout="this.style.background='#00d4aa'">
          Process Payment ${centsToUSD(totalCents)}
        </button>
    ...
    document.getElementById('process-payment-btn').addEventListener('click', () => {
      processSquareWebPayment();
    });

    document.getElementById('cancel-payment-btn').addEventListener('click', () => {
      closeSquareWebPayment();
    });
  }

  function closeSquareWebPayment() {
    const modal = document.getElementById('square-web-payment-modal');
    if (modal) {
      modal.remove();
    }
  }

  function processSquareWebPayment() {
    const modal = document.getElementById('square-web-payment-modal');
    if (!modal) return;
      ...
      ">
        <div style="margin-bottom: 30px;">
          ...
          <p style="
            ...
            fontSize: 16px;
            color: #6b7280;
          ">Please wait while we process your payment</p>
        </div>
      </div>
    `;
        ...
        ">
          <div style="margin-bottom: 30px;">
            ...
            <p style="
              ...
              fontSize: 14px;
              color: #6b7280;
            ">Transaction ID: WEB_${Date.now()}</p>
            <button onclick="document.getElementById('square-web-payment-modal').remove()" style="
              padding: 16px 32px;
              background: #10b981;
              color: white;
              border: none;
